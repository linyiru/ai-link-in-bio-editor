...
// .wrangler/tmp/bundle-MURPaS/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-MURPaS/middleware-insertion-facade.js
init_modules_watch_stub();
        ...
        },
        {
          ...
          mapRequestToAsset: /* @__PURE__ */ __name((req) => {
            ...
            if (!url2.pathname.includes(".") && !url2.pathname.startsWith("/api/")) {
              return new Request(`${url2.origin}/index.html`, {
                ...req,
                url: `${url2.origin}/index.html`
              });
            }
            return req;
          }, "mapRequestToAsset")
