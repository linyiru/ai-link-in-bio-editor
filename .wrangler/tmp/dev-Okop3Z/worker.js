...
// .wrangler/tmp/bundle-dcuSxD/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-dcuSxD/middleware-insertion-facade.js
init_modules_watch_stub();
    ...
    try {
      ...
      if (!env.__STATIC_CONTENT) {
        ...
        if (!url.pathname.includes(".") && !url.pathname.startsWith("/api/")) {
          const request2 = new Request(`${url.origin}/index.html`);
