...
// .wrangler/tmp/bundle-LwvHNk/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-LwvHNk/middleware-insertion-facade.js
init_modules_watch_stub();
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (!env.__STATIC_CONTENT) {
        console.log("No static content binding, serving index.html for SPA");
...
<head>
    ...
    <\/script>
    <script type="module" src="https://esm.sh/react@18.3.1"><\/script>
    <script type="module">
      ...
      const App = () => {
        return createElement('div', { 
          ...
          createElement('p', { key: 'desc', className: 'text-gray-400 mb-8' }, 'Loading...'),
          createElement('p', { key: 'note', className: 'text-sm text-gray-500' }, 'Development mode - static assets not available')
        ]));
      };
