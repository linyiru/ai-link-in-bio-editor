...
// .wrangler/tmp/bundle-EDiwd6/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-EDiwd6/middleware-insertion-facade.js
init_modules_watch_stub();
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (!env.__STATIC_CONTENT) {
        ...
        if (url.pathname === "/admin" || url.pathname === adminPath2) {
          return new Response('<!DOCTYPE html><html><head><title>Admin Panel</title><script src="https://cdn.tailwindcss.com"><\/script><script type="module" src="/assets/index-0cSgX1JQ.js"><\/script></head><body class="bg-gray-950"><div id="root"></div></body></html>', {
