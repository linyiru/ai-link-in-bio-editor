...
// .wrangler/tmp/bundle-Md83RH/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-Md83RH/middleware-insertion-facade.js
init_modules_watch_stub();
      ...
      try {
        ...
        if (env.IMAGES) {
          ...
          if (env.R2_PUBLIC_URL && !env.R2_PUBLIC_URL.includes("your-r2-bucket")) {
            ...
            console.log("\u{1F4A1} For faster loading, set up a custom domain:");
